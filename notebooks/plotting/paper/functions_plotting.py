                ...
                for tt in df_sub['time']:
                    ...
                    if(('qlc' in df_sub2.columns) & ('qic' in df_sub2.columns)):  
                        ...
                        if theta_step['qlr'].isna().sum() == 0:
                            ...
                            theta_step['theta_l'] = theta_step['ta']*pow((100000./theta_step['pa']),(rd/cp))*np.exp((lv*(theta_step['qlc']))/(cp*df_col2['ta']))
                            theta_step['theta_il'] = theta_step['ta']*pow((100000./theta_step['pa']),(rd/cp))*np.exp((lv*(theta_step['qlc']))/(cp*df_col2['ta']))
